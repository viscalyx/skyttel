...
export function PrototypeIcon({ name }: { name: string }) {
  const paths: Record<string, string> = {
    ...
    'pan-right': 'M4 12h16m-6-6 6 6-6 6',
    'pan-up': 'M12 20V4m-6 6 6-6 6 6',
    'pan-down': 'M12 4v16m-6-6 6 6 6-6',
    'rotate-left': 'M4 10a8 8 0 1 1 1 8M4 4v6h6',
    'rotate-right': 'M20 10a8 8 0 1 0-1 8M20 4v6h-6',
    'tilt-up': 'M4 18h16M7 14V9a5 5 0 0 1 10 0v5m-4-4 4 4 4-4',
    'tilt-down': 'M4 6h16M7 10v5a5 5 0 0 0 10 0v-5m-4 4 4-4 4 4',
    'zoom-in': 'M20 20l-5-5M17 10a7 7 0 1 1-14 0 7 7 0 0 1 14 0M7 10h6M10 7v6',
    'zoom-out': 'M20 20l-5-5M17 10a7 7 0 1 1-14 0 7 7 0 0 1 14 0M7 10h6',
    stars: 'm10 5 2 5 5 2-5 2-2 5-2-5-5-2 5-2 2-5M19 2v4m-2-2h4M20 17v4m-2-2h4',
    ...
    'depth-forward': 'M5 17h10v4H5zM10 16V3m-4 4 4-4 4 4M18 9l3 3-3 3',
    'depth-backward': 'M5 3h10v4H5zM10 8v13m-4-4 4 4 4-4M18 9l3 3-3 3',
