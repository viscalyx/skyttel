...
[EXPORT-07](../manual-tests/household-export.md#export-07-återkallad-tillgång-avbryter-pågående-hämtning).
...
Use the [manual case](../manual-tests/household-export.md#export-07-återkallad-tillgång-avbryter-pågående-hämtning)
