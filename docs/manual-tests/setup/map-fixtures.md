...
first. Use the configured first administrator for Alex and a separate real
test account for Robin. Provider authentication remains unchanged.
...
Continue [AVTAL-06](../contracts.md#avtal-06-uppgradering-bevarar-egna-definitioner-och-äldre-utkast)
...
Continue [PLACERING-05](../personal-view.md#placering-05-personlig-avskildhet-och-återkallad-tillgång).
